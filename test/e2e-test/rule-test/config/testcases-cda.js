...
const dataFiles = [
    '170.314B2_Amb_CCD.cda', 'Care_Plan.cda', 'CCD.cda', 'C-CDA_R2-1_CCD.xml.cda', 'CCD-Parent-Document-Replace-C-CDAR2.1.cda',
    ...
    'Discharge_Summary.cda', 'History_and_Physical.cda', 'Operative_Note.cda', 'Patient-1.cda',
...
module.exports = () => {
    ...
    dataFiles.forEach(dataFile => cases.push(
        ...templateFiles.map(templateFile => 
            ({ dataFile, templateFile, testRules: ruleSets.commonRules }))));
    return cases;
};
