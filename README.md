...
| **Available as** | 1. Self-deployed web service <br> (on-prem or on Azure)| 1. Command line tool <br> 2. $data-convert operation in Azure API for FHIR <br> 3. $data-convert operation in  FHIR Server for Azure (to be released soon)|
