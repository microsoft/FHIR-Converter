...
module fhirConverterDeploy 'Deploy-FhirConverterService.bicep' = {
  ...
  params: {
    ...
    templateStorageAccountName: deployTemplateStore ? templateStoreDeploy.outputs.templateStorageAccountName : ''
    templateStorageAccountContainerName: deployTemplateStore ? templateStoreDeploy.outputs.templateStorageAccountContainerName : ''
