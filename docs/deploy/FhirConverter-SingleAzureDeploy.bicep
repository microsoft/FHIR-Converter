...
// Deploy a keyVault if deploying any resources that require it
var deployKeyVault = deployApplicationInsights

module dependentResourceDeploy 'Deploy-DependentResources.bicep' = if (deployTemplateStore || deployKeyVault) {
...
module fhirConverterDeploy 'Deploy-FhirConverterService.bicep' = {
  ...
  params: {
    ...
    templateStorageAccountName: deployTemplateStore ? dependentResourceDeploy.outputs.templateStorageAccountName : ''
    templateStorageAccountContainerName: deployTemplateStore ? dependentResourceDeploy.outputs.templateStorageAccountContainerName : ''
    ...
    applicationInsightsUAMIName: deployApplicationInsights ? convertInfrastructureDeploy.outputs.applicationInsightsUAMIName: ''
    applicationInsightsConnectionStringSecretName: deployApplicationInsights ? convertInfrastructureDeploy.outputs.applicationInsightsConnStringSecretName : ''
