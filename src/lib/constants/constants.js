...
module.exports.JSON_TEMPLATE_LOCATION = path.join(__dirname, serviceTemplateFolder, 'json');
module.exports.JSON_DATA_LOCATION = path.join(__dirname, sampleDataFolder, 'json');
