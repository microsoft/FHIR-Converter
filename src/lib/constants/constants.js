...
module.exports.REDOX_TEMPLATE_LOCATION = path.join(__dirname, serviceTemplateFolder, 'redox');
module.exports.REDOX_DATA_LOCATION = path.join(__dirname, sampleDataFolder, 'redox');
