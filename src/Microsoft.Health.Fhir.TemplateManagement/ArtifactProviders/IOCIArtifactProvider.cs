...
namespace Microsoft.Health.Fhir.TemplateManagement.ArtifactProviders
{
    public interface IOCIArtifactProvider
    {
        ...
        Task<List<ArtifactLayer>> GetOCIArtifactAsync(CancellationToken cancellationToken = default);
        ...
        Task<ArtifactLayer> GetLayerAsync(string digest, CancellationToken cancellationToken = default);
    }
}
