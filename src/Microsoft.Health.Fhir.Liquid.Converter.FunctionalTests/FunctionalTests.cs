    ...
    public class FunctionalTests
    {
        public static IEnumerable<object[]> GetDataForHl7v2()
        {
            var data = new List<string[]>
            {
                ...
                new[] { "ORU_R01", "ORU-R01_1.hl7",  @"ORU-R01_1-expected.json"},

                new[] { @"ORM_O01", @"ORM_O01_01.hl7", @"ORM_O01_01-expected.json" },
                new[] { @"ORM_O01", @"ORM_O01_02.hl7", @"ORM_O01_02-expected.json" },
                new[] { @"ORM_O01", @"ORM_O01_03.hl7", @"ORM_O01_03-expected.json" },
                ...
                new[] { "OML_O21", "OML_O21_01.hl7",  @"OML_O21-01-expected.json"},
                new[] { "OML_O21", "OML_O21_02.hl7",  @"OML_O21-02-expected.json"},
